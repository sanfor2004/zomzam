    ...
    <main>
        <div class="hero-container">
            ...
            <div class="contact-buttons">
                <a href="mailto:contact@zomzam.com" class="contact-btn icon-only email-btn" title="Email us">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="2" y="4" width="20" height="16" rx="2"/>
                        <path d="m2 7 10 7 10-7"/>
                    </svg>
                </a>
                <a href="tel:+201060336394" class="contact-btn icon-only phone-btn" title="Call us">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="https://www.facebook.com/zomzam.ar" target="_blank" rel="noopener noreferrer" class="contact-btn icon-only facebook-btn" title="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
