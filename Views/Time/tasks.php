...
<!-- Edit Task Modal -->
<div id="modal-edit-task" class="fixed inset-0 z-50 hidden items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
  <div class="bg-white dark:bg-[#1a1d24] w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
    <div class="p-8">
      <div class="flex items-center justify-between mb-8">
        ...
        <button onclick="closeModal('modal-edit-task')" class="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors">
      ...
      <div class="space-y-6">
        <div>
          ...
          <input id="edit-task-title" type="text" class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-lg font-bold focus:outline-none focus:border-primary-500 transition-all">
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <div class="relative">
              ...
              <button type="button" id="edit-priority-btn" class="w-full flex items-center justify-between px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl text-sm focus:outline-none">
              ...
              <div id="edit-priority-dropdown" class="absolute left-0 right-0 top-full mt-1 bg-white dark:bg-[#1a1d24] border border-slate-200 dark:border-slate-700 rounded-xl shadow-lg z-20 hidden overflow-hidden">
                <div class="edit-priority-option flex items-center gap-2 px-3 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer" data-value="urgent" data-label="Urgent" data-color="bg-red-400">
                  <span class="w-2.5 h-2.5 rounded-full bg-red-400"></span><span class="text-sm">Urgent</span>
                </div>
                <div class="edit-priority-option flex items-center gap-2 px-3 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer" data-value="medium" data-label="Medium" data-color="bg-amber-400">
                  <span class="w-2.5 h-2.5 rounded-full bg-amber-400"></span><span class="text-sm">Medium</span>
                </div>
                <div class="edit-priority-option flex items-center gap-2 px-3 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer" data-value="maybe" data-label="Maybe" data-color="bg-blue-400">
                  <span class="w-2.5 h-2.5 rounded-full bg-blue-400"></span><span class="text-sm">Maybe</span>
                </div>
                <div class="edit-priority-option flex items-center gap-2 px-3 py-2.5 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer" data-value="free" data-label="Free" data-color="bg-slate-300">
          ...
          <div>
            ...
            <select id="edit-task-duration" class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl text-sm focus:outline-none">
              <option value="15">15 min</option>
        ...
        <div>
          <label class="text-xs font-black text-slate-400 uppercase tracking-widest mb-2 block">Link to Dream Goal</label>
          <select id="edit-task-horizon" class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl text-sm focus:outline-none">
            <!-- JS will populate -->
          </select>
        </div>
        ...
        })" class="w-full py-4 bg-primary-500 hover:bg-primary-600 text-white font-black rounded-2xl shadow-lg shadow-primary-500/20 transition-all active:scale-95">Update Task</button>
      </div>
    </div>
  </div>
</div>
