  ...
  return (
    <div ref={pageRef} className="min-h-screen w-full bg-[#09090b] flex items-center justify-center relative overflow-hidden">
      ...
      {/* ──────────────────────────────────────────────────────────
          ...
          Google sign-in, Divider OR, form fields (GSAP stagger),
      ...
      >
        <div className="p-8 space-y-5">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 bg-white/[0.04] border border-white/[0.07] rounded-xl text-[13px] font-semibold text-slate-300 hover:bg-white/[0.07] hover:border-white/[0.13] hover:text-white transition-all duration-150"
          >
