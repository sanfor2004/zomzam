// Non-English translation dictionaries, code-split out of the main bundle.
// Dynamically imported by TranslationContext only when a non-English language
// is selected (or restored from localStorage), so English-only users never
// download these. English stays inline in TranslationContext as the default
// and fallback.
