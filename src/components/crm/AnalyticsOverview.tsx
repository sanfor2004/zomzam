    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#1A1D24] border border-slate-800/60 rounded-3xl p-6 shadow-apple hover:shadow-apple-lg hover:border-[#EE5712]/30 transition-all duration-300 relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Acquisition Rate</span>
          ...
          <div className="w-full bg-slate-800 h-2 rounded-full mt-4.5 overflow-hidden">
        ...
        <div className="bg-[#1A1D24] border border-slate-800/60 rounded-3xl p-6 shadow-apple hover:shadow-apple-lg hover:border-[#EE5712]/30 transition-all duration-300 relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Website Density</span>
          ...
          <p className="text-xs text-slate-400 mt-3.5 font-bold leading-none">
            <span className="font-extrabold text-cyan-400">{stats.leadsWithWebsites}</span> domains collected
          </p>
        </div>
        ...
        <div className="bg-[#1A1D24] border border-slate-800/60 rounded-3xl p-6 shadow-apple hover:shadow-apple-lg hover:border-[#EE5712]/30 transition-all duration-300 relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Phone Coverage</span>
          ...
          <p className="text-xs text-slate-400 mt-3.5 font-bold leading-none">
            <span className="font-extrabold text-amber-400">{stats.leadsWithPhones}</span> phone lines verified
          </p>
        </div>
        ...
        <div className="bg-[#1A1D24] border border-slate-800/60 rounded-3xl p-6 shadow-apple flex flex-col justify-between space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-black text-slate-350 uppercase tracking-widest">Pipeline Conversion Funnel</h3>
            </div>
          ...
          <div className="space-y-4 py-2 flex flex-col items-center">
            ...
            <div className="w-full transition-all duration-300 hover:scale-[1.01] cursor-pointer">
              <div className="relative p-4 rounded-2xl border border-slate-800/50 bg-slate-900/20 overflow-hidden">
                ...
                <div className="relative z-10 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-200">1. Discovery Stage (New)</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-bold text-slate-500">{stats.newLeads} Leads</span>
                    <Badge className="text-[10px] font-extrabold bg-orange-500/10 border border-orange-500/20 text-orange-400">{newPercent}%</Badge>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative p-4 rounded-2xl border border-slate-800/50 bg-slate-900/20 overflow-hidden">
                ...
                <div className="relative z-10 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-200">2. Outreach Stage (Contacted)</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-bold text-slate-500">{stats.contactedLeads} Leads</span>
                    <Badge className="text-[10px] font-extrabold bg-amber-500/10 border border-amber-500/20 text-amber-400">{contactedPercent}%</Badge>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative p-4 rounded-2xl border border-slate-800/50 bg-slate-900/20 overflow-hidden">
                ...
                <div className="relative z-10 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-200">3. Pipeline Stage (Qualified)</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-bold text-slate-500">{stats.qualifiedLeads} Leads</span>
                    <Badge className="text-[10px] font-extrabold bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">{qualifiedPercent}%</Badge>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-[82%] transition-all duration-300 hover:scale-[1.01] cursor-pointer">
              <div className="relative p-4 rounded-2xl border border-[#EE5712]/20 bg-[#EE5712]/10 overflow-hidden">
                ...
                <div className="relative z-10 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-black text-white">4. Conversion Rate</span>
                  </div>
                  <div className="flex items-center gap-3">
        ...
        <div className="bg-[#1A1D24] border border-slate-800/60 rounded-3xl p-6 shadow-apple space-y-6">
          ...
          <div className="space-y-5 pt-1 overflow-y-auto max-h-[280px] pr-1 custom-scrollbar">
            {stats.industryDistribution.length === 0 ? (
              <div className="text-center py-10 text-slate-600 italic text-xs font-semibold">No industry details available.</div>
            ) : (
                ...
                return (
                  <div key={item.industry} className="space-y-1.5">
                    <div className="flex justify-between items-center text-xs">
                      <span className="font-bold text-slate-200">{item.industry}</span>
                      <span className="text-slate-500 font-bold">{item.count} leads ({itemPercent}% )</span>
                    </div>
