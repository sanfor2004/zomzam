                      ...
                      <div className="relative flex-shrink-0">
                        ...
                        {menuOpen && (
                          <>
                            ...
                            />
                            <div className="absolute right-0 bottom-full mb-1 z-[2] w-32 surface-card border border-slate-800/70 rounded-xl shadow-2xl p-1">
                              <button
                                type="button"
          ...
          <div className="relative flex items-center gap-2 p-2.5 border-t border-slate-800/60">
            ...
            {emojiOpen && (
              <>
                ...
                />
                <div className="absolute bottom-full left-2.5 mb-2 z-[2] w-[232px] surface-card border border-slate-800/70 rounded-2xl shadow-2xl p-2 grid grid-cols-8 gap-0.5">
